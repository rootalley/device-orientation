...
#ifndef FLUTTER_ROTATION_SENSOR_SWIFT_H
#define FLUTTER_ROTATION_SENSOR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="flutter_rotation_sensor",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class FlutterError;
SWIFT_CLASS("_TtC23flutter_rotation_sensor27FlutterRotationSensorPlugin")
@interface FlutterRotationSensorPlugin : NSObject <FlutterPlugin, FlutterStreamHandler>
